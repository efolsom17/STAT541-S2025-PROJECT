...
car::Anova(fit.lm.PGE2.log) |> kable(caption= "Analysis of Deviance Table (Type II Wald Chi-Squared tests)")
emm.log <- emmeans(fit.lm.PGE2.log, specs = "TRT", adjust = "bonferroni")
pairs(emm.log) |> kable(caption = "Estimated Contrasts: Treatment Effects")
confint(pairs(emm.log)) |> kable(caption = "Confidence Intervals: Treatment Effects")
```
